...
def even_better_draw_circles(n, color, centerpoint):
    window = rg.RoseWindow(1000, 1000)

    for k in range(21):
        circle = rg.Circle(centerpoint, n * k)
        circle.attach_to(window)
...
def run_test_even_better_draw_circles():
    even_better_draw_circles(5, 'blue', rg.Point(500, 500))
    even_better_draw_circles(10, 'red', rg.Point(500, 500))
    even_better_draw_circles(15, 'green', rg.Point(500, 500))
